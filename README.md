...
| `test_provider_router.py` | **59** | **19B + 20B** | Router: classification, retry, circuit breaker, health, failover, streaming, snapshots, redaction, API, metrics store, typed per-capability fallbacks, mid-stream token-loss resume |
| **Total** | **1672** | **All** | (18 skipped = live-GitHub/PG-dependent) |
